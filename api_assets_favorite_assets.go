...
/* 
AssetsFavoriteAssetsApiService assets_favorite-assets_bulk_delete

 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *AssetsFavoriteAssetsBulkDeleteOpts - Optional Parameters:
...
func (a *AssetsFavoriteAssetsApiService) AssetsFavoriteAssetsBulkDelete(ctx context.Context, localVarOptionals *AssetsFavoriteAssetsBulkDeleteOpts) (*http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/assets/favorite-assets/"
...
func (a *AssetsFavoriteAssetsApiService) AssetsFavoriteAssetsBulkUpdate(ctx context.Context, data FavoriteAsset) (FavoriteAsset, *http.Response, error) {
	var (
		...
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue FavoriteAsset
	)
...
func (a *AssetsFavoriteAssetsApiService) AssetsFavoriteAssetsDelete(ctx context.Context, id string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/assets/favorite-assets/{id}/"
...
/* 
AssetsFavoriteAssetsApiService assets_favorite-assets_list

 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *AssetsFavoriteAssetsListOpts - Optional Parameters:
     * @param "Asset" (optional.String) -  
     * @param "Search" (optional.String) -  A search term.
     * @param "Order" (optional.String) -  Which field to use when ordering the results.
