...
func (a *AuthenticationAccessKeysApiService) AuthenticationAccessKeysCreate(ctx context.Context, data AccessKey) (AccessKey, *http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/authentication/access-keys/"
...
func (a *AuthenticationAccessKeysApiService) AuthenticationAccessKeysDelete(ctx context.Context, id string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/authentication/access-keys/{id}/"
...
/* 
AuthenticationAccessKeysApiService authentication_access-keys_list

 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *AuthenticationAccessKeysListOpts - Optional Parameters:
