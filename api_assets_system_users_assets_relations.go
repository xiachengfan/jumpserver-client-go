...
/* 
AssetsSystemUsersAssetsRelationsApiService assets_system-users-assets-relations_bulk_delete

 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *AssetsSystemUsersAssetsRelationsBulkDeleteOpts - Optional Parameters:
...
func (a *AssetsSystemUsersAssetsRelationsApiService) AssetsSystemUsersAssetsRelationsBulkDelete(ctx context.Context, localVarOptionals *AssetsSystemUsersAssetsRelationsBulkDeleteOpts) (*http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/assets/system-users-assets-relations/"
...
*/
func (a *AssetsSystemUsersAssetsRelationsApiService) AssetsSystemUsersAssetsRelationsBulkUpdate(ctx context.Context, data SystemUserAssetRelation) (SystemUserAssetRelation, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue SystemUserAssetRelation
	)
...
@return SystemUserAssetRelation
*/
func (a *AssetsSystemUsersAssetsRelationsApiService) AssetsSystemUsersAssetsRelationsCreate(ctx context.Context, data SystemUserAssetRelation) (SystemUserAssetRelation, *http.Response, error) {
	var (
...
func (a *AssetsSystemUsersAssetsRelationsApiService) AssetsSystemUsersAssetsRelationsDelete(ctx context.Context, id string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/assets/system-users-assets-relations/{id}/"
...
/* 
AssetsSystemUsersAssetsRelationsApiService assets_system-users-assets-relations_list

 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *AssetsSystemUsersAssetsRelationsListOpts - Optional Parameters:
     * @param "Id" (optional.Float32) -  
     * @param "Asset" (optional.String) -  
     * @param "Systemuser" (optional.String) -  
     * @param "Search" (optional.String) -  A search term.
...
func (a *AssetsSystemUsersAssetsRelationsApiService) AssetsSystemUsersAssetsRelationsList(ctx context.Context, localVarOptionals *AssetsSystemUsersAssetsRelationsListOpts) (InlineResponse20017, *http.Response, error) {
	var (
...
@return SystemUserAssetRelation
*/
func (a *AssetsSystemUsersAssetsRelationsApiService) AssetsSystemUsersAssetsRelationsUpdate(ctx context.Context, id string, data SystemUserAssetRelation) (SystemUserAssetRelation, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
