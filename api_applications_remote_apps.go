...
/* 
ApplicationsRemoteAppsApiService applications_remote-apps_bulk_delete

 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ApplicationsRemoteAppsBulkDeleteOpts - Optional Parameters:
...
func (a *ApplicationsRemoteAppsApiService) ApplicationsRemoteAppsBulkDelete(ctx context.Context, localVarOptionals *ApplicationsRemoteAppsBulkDeleteOpts) (*http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/applications/remote-apps/"
...
func (a *ApplicationsRemoteAppsApiService) ApplicationsRemoteAppsConnectionInfoRead(ctx context.Context, id string) (RemoteAppConnectionInfo, *http.Response, error) {
	var (
		...
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue RemoteAppConnectionInfo
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/applications/remote-apps/{id}/connection-info/"
...
func (a *ApplicationsRemoteAppsApiService) ApplicationsRemoteAppsDelete(ctx context.Context, id string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/applications/remote-apps/{id}/"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
...
/* 
ApplicationsRemoteAppsApiService applications_remote-apps_list

 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ApplicationsRemoteAppsListOpts - Optional Parameters:
     * @param "Name" (optional.String) -  
     * @param "Search" (optional.String) -  A search term.
     * @param "Order" (optional.String) -  Which field to use when ordering the results.
     * @param "Spm" (optional.String) - 
