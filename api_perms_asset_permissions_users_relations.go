...
/* 
PermsAssetPermissionsUsersRelationsApiService perms_asset-permissions-users-relations_bulk_delete

 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *PermsAssetPermissionsUsersRelationsBulkDeleteOpts - Optional Parameters:
...
func (a *PermsAssetPermissionsUsersRelationsApiService) PermsAssetPermissionsUsersRelationsBulkDelete(ctx context.Context, localVarOptionals *PermsAssetPermissionsUsersRelationsBulkDeleteOpts) (*http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/perms/asset-permissions-users-relations/"
...
*/
func (a *PermsAssetPermissionsUsersRelationsApiService) PermsAssetPermissionsUsersRelationsBulkUpdate(ctx context.Context, data AssetPermissionUserRelation) (AssetPermissionUserRelation, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue AssetPermissionUserRelation
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v AssetPermissionUserRelation
...
@return AssetPermissionUserRelation
*/
func (a *PermsAssetPermissionsUsersRelationsApiService) PermsAssetPermissionsUsersRelationsCreate(ctx context.Context, data AssetPermissionUserRelation) (AssetPermissionUserRelation, *http.Response, error) {
	var (
...
func (a *PermsAssetPermissionsUsersRelationsApiService) PermsAssetPermissionsUsersRelationsDelete(ctx context.Context, id string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/perms/asset-permissions-users-relations/{id}/"
...
/* 
PermsAssetPermissionsUsersRelationsApiService perms_asset-permissions-users-relations_list

 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *PermsAssetPermissionsUsersRelationsListOpts - Optional Parameters:
     * @param "Id" (optional.Float32) -  
     * @param "User" (optional.String) -  
     * @param "Assetpermission" (optional.String) -  
     * @param "Search" (optional.String) -  A search term.
...
func (a *PermsAssetPermissionsUsersRelationsApiService) PermsAssetPermissionsUsersRelationsList(ctx context.Context, localVarOptionals *PermsAssetPermissionsUsersRelationsListOpts) (InlineResponse20034, *http.Response, error) {
	var (
...
@return AssetPermissionUserRelation
*/
func (a *PermsAssetPermissionsUsersRelationsApiService) PermsAssetPermissionsUsersRelationsPartialUpdate(ctx context.Context, id string, data AssetPermissionUserRelation) (AssetPermissionUserRelation, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Patch")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return AssetPermissionUserRelation
*/
func (a *PermsAssetPermissionsUsersRelationsApiService) PermsAssetPermissionsUsersRelationsUpdate(ctx context.Context, id string, data AssetPermissionUserRelation) (AssetPermissionUserRelation, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
