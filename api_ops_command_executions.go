...
func (a *OpsCommandExecutionsApiService) OpsCommandExecutionsCreate(ctx context.Context, data CommandExecution) (CommandExecution, *http.Response, error) {
	var (
		...
		localVarReturnValue CommandExecution
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/ops/command-executions/"
...
func (a *OpsCommandExecutionsApiService) OpsCommandExecutionsDelete(ctx context.Context, id string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/ops/command-executions/{id}/"
...
/* 
OpsCommandExecutionsApiService ops_command-executions_list

 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *OpsCommandExecutionsListOpts - Optional Parameters:
