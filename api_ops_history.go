...
*/
func (a *OpsHistoryApiService) OpsHistoryCreate(ctx context.Context, data AdHocRunHistory) (AdHocRunHistory, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue AdHocRunHistory
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/ops/history/"
...
func (a *OpsHistoryApiService) OpsHistoryDelete(ctx context.Context, id string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/ops/history/{id}/"
...
/* 
OpsHistoryApiService ops_history_list

 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *OpsHistoryListOpts - Optional Parameters:
...
@return AdHocRunHistory
*/
func (a *OpsHistoryApiService) OpsHistoryUpdate(ctx context.Context, id string, data AdHocRunHistory) (AdHocRunHistory, *http.Response, error) {
	var (
