...
func (a *OpsAdhocApiService) OpsAdhocCreate(ctx context.Context, data AdHoc) (AdHoc, *http.Response, error) {
	var (
		...
		localVarReturnValue AdHoc
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/ops/adhoc/"
...
func (a *OpsAdhocApiService) OpsAdhocDelete(ctx context.Context, id string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/ops/adhoc/{id}/"
...
/* 
OpsAdhocApiService ops_adhoc_list

 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *OpsAdhocListOpts - Optional Parameters:
