...
/* 
ApplicationsDatabaseAppsApiService applications_database-apps_bulk_delete

 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ApplicationsDatabaseAppsBulkDeleteOpts - Optional Parameters:
...
func (a *ApplicationsDatabaseAppsApiService) ApplicationsDatabaseAppsBulkDelete(ctx context.Context, localVarOptionals *ApplicationsDatabaseAppsBulkDeleteOpts) (*http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/applications/database-apps/"
...
func (a *ApplicationsDatabaseAppsApiService) ApplicationsDatabaseAppsBulkUpdate(ctx context.Context, data DatabaseApp) (DatabaseApp, *http.Response, error) {
	var (
		...
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue DatabaseApp
	)
...
func (a *ApplicationsDatabaseAppsApiService) ApplicationsDatabaseAppsDelete(ctx context.Context, id string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/applications/database-apps/{id}/"
...
/* 
ApplicationsDatabaseAppsApiService applications_database-apps_list

 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ApplicationsDatabaseAppsListOpts - Optional Parameters:
     * @param "Name" (optional.String) -  
     * @param "Search" (optional.String) -  A search term.
     * @param "Order" (optional.String) -  Which field to use when ordering the results.
     * @param "Spm" (optional.String) - 
