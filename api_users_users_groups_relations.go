...
/* 
UsersUsersGroupsRelationsApiService users_users-groups-relations_bulk_delete

 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *UsersUsersGroupsRelationsBulkDeleteOpts - Optional Parameters:
...
func (a *UsersUsersGroupsRelationsApiService) UsersUsersGroupsRelationsBulkDelete(ctx context.Context, localVarOptionals *UsersUsersGroupsRelationsBulkDeleteOpts) (*http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/users/users-groups-relations/"
...
*/
func (a *UsersUsersGroupsRelationsApiService) UsersUsersGroupsRelationsBulkUpdate(ctx context.Context, data UserUserGroupRelation) (UserUserGroupRelation, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue UserUserGroupRelation
	)
...
@return UserUserGroupRelation
*/
func (a *UsersUsersGroupsRelationsApiService) UsersUsersGroupsRelationsCreate(ctx context.Context, data UserUserGroupRelation) (UserUserGroupRelation, *http.Response, error) {
	var (
...
func (a *UsersUsersGroupsRelationsApiService) UsersUsersGroupsRelationsDelete(ctx context.Context, id string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/users/users-groups-relations/{id}/"
...
/* 
UsersUsersGroupsRelationsApiService users_users-groups-relations_list

 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *UsersUsersGroupsRelationsListOpts - Optional Parameters:
     * @param "User" (optional.String) -  
     * @param "Usergroup" (optional.String) -  
     * @param "Search" (optional.String) -  A search term.
     * @param "Order" (optional.String) -  Which field to use when ordering the results.
...
@return UserUserGroupRelation
*/
func (a *UsersUsersGroupsRelationsApiService) UsersUsersGroupsRelationsUpdate(ctx context.Context, id string, data UserUserGroupRelation) (UserUserGroupRelation, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
